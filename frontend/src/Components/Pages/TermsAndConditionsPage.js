...
const TermsAndConditionsPage = () => {
    ...
    <ul><strong>Compte et sécurité</strong></ul>
    ...
    <ul><strong>Utilisation du Service</strong></ul>
    ...
    <ul><strong>Propriété intellectuelle</strong></ul>
    ...
    <ul><strong>Limitation de responsabilité</strong></ul>
